...
public final class LinkDatabase implements Closeable {
    public record Link(int groupId, int objectIndex, TypePath path) {
    }
    ...
    public static LinkDatabase open(DecimaGame game, Path path) throws IOException {
