...
public class HingeConstraintSettings extends TwoBodyConstraintSettings {
    ...
    public void restoreBinaryState(BinaryReader reader) throws IOException {
        ...
        point1 = JoltUtils.readVec3(reader);
        hingeAxis1 = JoltUtils.readVec3(reader);
        normalAxis1 = JoltUtils.readVec3(reader);
        point2 = JoltUtils.readVec3(reader);
        hingeAxis2 = JoltUtils.readVec3(reader);
        normalAxis2 = JoltUtils.readVec3(reader);
