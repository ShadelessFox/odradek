...
import sh.adelessfox.odradek.game.ds2.rtti.DS2.ShaderResource;
...
public final class ShaderResourceCallback implements ExtraBinaryDataCallback<ShaderResource> {
    @Override
