...
public final class FontResourceToFontConverter implements Converter<DS2.FontResource, Font, DS2Game> {
    @Override
    public Optional<Font> convert(DS2.FontResource object, DS2Game game) {
    ...
    private static Font.Metrics convertFontMetrics(DS2.FontTextMetrics metrics) {
    ...
    private static Glyph convertGlyph(DS2.FontCodePointGlyphInfo info) {
    ...
    private static Glyph.Contour convertGlyphContour(DS2.GlyphContour contour) {
    ...
    private static Vector2 convertGlyphPoint(DS2.Vec2Pack point) {
        return new Vector2(point.x(), point.y());
    }

    private static Glyph.Command convertGlyphCommand(DS2.GlyphContourCmd command) {
    ...
    private static Glyph.Metrics convertGlyphMetrics(DS2.FontCodePointGlyphInfo info) {
        var advanceWidth = info.glyphMetrics().advanceWidth();
        return new Glyph.Metrics(advanceWidth);
    }

    private static Glyph.Bounds convertGlyphBounds(DS2.FontCodePointGlyphInfo info) {
