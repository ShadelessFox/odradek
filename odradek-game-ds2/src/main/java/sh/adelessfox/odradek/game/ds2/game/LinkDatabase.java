...
public final class LinkDatabase implements LinkProvider {
    ...
    private LinkDatabase(DS2Game game, BinaryReader reader, int[] offsets) {
        this.game = game;
        this.reader = reader;
        this.offsets = offsets;
    }

    public static LinkDatabase open(DS2Game game, Path path) throws IOException {
    ...
    public static HashCode computeHash(DS2Game game) throws IOException {
        var graph = game.getStreamingGraph();
