...
import sh.adelessfox.odradek.lua.LuaHeader;
import sh.adelessfox.odradek.lua.LuaProto;
...
public class CoreScriptCallback implements ExtraBinaryDataCallback<CoreScriptCallback.Script> {
    ...
    @Override
    public void deserialize(BinaryReader reader, TypeFactory factory, Script object) throws IOException {
