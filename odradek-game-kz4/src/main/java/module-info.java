import sh.adelessfox.odradek.game.kz4.rtti.callbacks.*;
...
@GenerateBindings(
    ...
    target = "sh.adelessfox.odradek.game.kz4.rtti.Killzone4",
    builtins = {
...
module decima.game.kz4 {
    ...
    opens sh.adelessfox.odradek.game.kz4.rtti to odradek.rtti;
    opens sh.adelessfox.odradek.game.kz4.rtti.callbacks to odradek.rtti;
    opens sh.adelessfox.odradek.game.kz4.rtti.data to odradek.rtti;

    exports sh.adelessfox.odradek.game.kz4.rtti.callbacks;
    exports sh.adelessfox.odradek.game.kz4.rtti.data;
    exports sh.adelessfox.odradek.game.kz4.rtti;
}
