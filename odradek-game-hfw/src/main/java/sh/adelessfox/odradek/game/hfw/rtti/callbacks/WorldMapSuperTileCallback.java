...
public class WorldMapSuperTileCallback implements ExtraBinaryDataCallback<HFW.WorldMapSuperTile> {
    @Override
    public void deserialize(BinaryReader reader, TypeFactory factory, HFW.WorldMapSuperTile object) throws IOException {
        var smallTextureSize = reader.readInt();
        var largeTextureSize = reader.readInt();
        var mask = reader.readInt();

        var smallTextures = new ArrayList<HFW.TextureInfo>(4);
        var largeTextures = new ArrayList<HFW.TextureInfo>(4);
