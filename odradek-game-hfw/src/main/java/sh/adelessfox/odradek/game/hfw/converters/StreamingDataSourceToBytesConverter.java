...
public class StreamingDataSourceToBytesConverter implements Converter<StreamingDataSource, byte[], HFWGame> {
    @Override
    public Optional<byte[]> convert(StreamingDataSource object, HFWGame game) {
        try {
