...
import sh.adelessfox.odradek.game.hfw.middleware.jolt.physics.collision.CollisionGroup;
import sh.adelessfox.odradek.game.hfw.middleware.jolt.physics.collision.GroupFilter;
import sh.adelessfox.odradek.game.hfw.middleware.jolt.physics.collision.PhysicsMaterial;
import sh.adelessfox.odradek.game.hfw.middleware.jolt.physics.collision.shape.Shape;
...
public class BodyCreationSettings {
    ...
    public void restoreBinaryState(BinaryReader reader) throws IOException {
        ...
        allowDynamicOrKinematic = reader.readBool(BoolFormat.BYTE);
        motionQuality = MotionQuality.values()[reader.readByte()];
        allowSleeping = reader.readBool(BoolFormat.BYTE);
