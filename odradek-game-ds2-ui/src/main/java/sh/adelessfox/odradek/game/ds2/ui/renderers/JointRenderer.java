...
import sh.adelessfox.odradek.game.ds2.rtti.DS2.Joint;
...
public final class JointRenderer implements Renderer.OfObject<Joint, DS2Game> {
    @Override
    public Optional<StyledText> styledText(TypeInfo info, Joint object, DS2Game game) {
