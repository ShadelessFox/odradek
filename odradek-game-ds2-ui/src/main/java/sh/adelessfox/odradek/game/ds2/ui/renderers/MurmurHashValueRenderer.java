...
public final class MurmurHashValueRenderer implements Renderer.OfObject<MurmurHashValue, DS2Game> {
    @Override
    public Optional<String> text(TypeInfo info, MurmurHashValue object, DS2Game game) {
