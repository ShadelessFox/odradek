...
import sh.adelessfox.odradek.game.ds2.rtti.DS2.EnumFact;
...
public final class EnumFact$DefaultValueUUIDRenderer implements Renderer.OfAttribute<EnumFact, DS2Game> {
    @Override
    public Optional<StyledText> styledText(TypeInfo info, EnumFact object, DS2Game game) {
