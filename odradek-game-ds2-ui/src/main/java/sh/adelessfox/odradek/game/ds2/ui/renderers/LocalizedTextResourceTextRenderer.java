...
public final class LocalizedTextResourceTextRenderer implements Renderer.OfObject<DS2.LocalizedTextResourceText, DS2Game> {
    @Override
    public Optional<StyledText> styledText(TypeInfo info, DS2.LocalizedTextResourceText object, DS2Game game) {
