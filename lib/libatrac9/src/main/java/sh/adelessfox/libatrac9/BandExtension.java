...
final class BandExtension {
    ...
    public static void GetBexBandInfo(int[] bandCount, int[] groupAUnit, int[] groupBUnit, int quantUnits) {
    ...
    public static final byte[][] BexGroupInfo =
        {
            new byte[]{16, 21, 0},
            new byte[]{18, 22, 1},
            new byte[]{20, 22, 2},
    ...
    public static final byte[][] BexEncodedValueCounts =
        {
    ...
    public static final byte[][][] BexDataLengths =
        {
            {
                new byte[]{0, 0, 0, 0},
                new byte[]{0, 0, 0, 0},
    ...
    public static final double[][] BexMode0Bands3 =
        {
            {
    ...
    public static final double[][] BexMode0Bands4 =
        {
            {
    ...
    public static final double[][] BexMode0Bands5 =
        {
            {
    ...
    public static final double[] BexMode2Scale =
        {
    ...
    public static final double[] BexMode3Initial =
        {
    ...
    public static final double[] BexMode3Rate =
        {
    ...
    public static final double[] BexMode4Multiplier =
        {
