...
import sh.adelessfox.odradek.rtti.Category;
...
final class RuntimeTypeGenerator {
    ...
    RuntimeTypeGenerator(MethodHandles.Lookup lookup) {
        this.lookup = lookup;
    }
     ...
     */
    public MethodHandles.Lookup generate(Class<?> cls) throws ReflectiveOperationException {
        if (!cls.isInterface()) {
    ...
    private MethodHandles.Lookup generateClass(Class<?> cls) throws ReflectiveOperationException {
    ...
    private static void generateAttrField(ClassWriter writer, AttrInfo attr) {
    ...
    private static List<CategoryInfo> collectCategories(Class<?> cls) {
    ...
    private static List<AttrInfo> collectAttrs(Class<?> cls) throws ReflectiveOperationException {
