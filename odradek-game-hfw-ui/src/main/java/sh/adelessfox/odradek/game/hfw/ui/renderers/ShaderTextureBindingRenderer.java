...
import sh.adelessfox.odradek.game.hfw.rtti.HFW.ShaderTextureBinding;
...
public class ShaderTextureBindingRenderer implements Renderer.OfObject<ShaderTextureBinding, HFWGame> {
    @Override
    public Optional<StyledText> styledText(TypeInfo info, ShaderTextureBinding object, HFWGame game) {
