...
public class TextureSetEntry$PackingInfoRenderer implements Renderer.OfAttribute<HFW.TextureSetEntry, HFWGame> {
    @Override
    public Optional<String> text(TypeInfo info, HFW.TextureSetEntry object, HFWGame game) {
        return Optional.of(String.valueOf(object.packingInfo()));
    }

    @Override
    public Optional<StyledText> styledText(TypeInfo info, HFW.TextureSetEntry object, HFWGame game) {
