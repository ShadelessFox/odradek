...
public final class SentenceResourceRenderer implements Renderer.OfObject<HFW.SentenceResource, HFWGame> {
    @Override
    public Optional<StyledText> styledText(TypeInfo info, HFW.SentenceResource object, HFWGame game) {
